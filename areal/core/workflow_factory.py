...
This is the ONLY factory - all component creation and wiring happens here.
"""
...
def create_workflow_executor(
    ...
    This function is a convenience wrapper that calls create_workflow_executor_with_events()
    and returns only the executor for backward compatibility.
    ...
    **Standard PPO mode** (``enable_segment_wise_ppo=False``):
    ...
    See Also
    --------
    create_workflow_executor_with_events : Factory that returns (executor, registry)
    WorkflowExecutor : Main executor class
    EventRegistry : Manages event handlers
    """
    # Delegate to create_workflow_executor_with_events and return only the executor
