...
class SegmentWisePPOStrategy(StalenessControlStrategy):
    ...
    def __init__(self, config: InferenceEngineConfig | None = None, logger=None):
        ...
        super().__init__(config)
        self.logger = logger
        # Metrics for staleness decisions
    ...
    def is_sample_too_stale(
        ...
        try:
            ...
            is_stale = staleness > allow_staleness
            ...
            # Periodic summary logging (every 100 checks)
            if self.logger and self._total_checks % 100 == 0:
                self.logger.debug(
