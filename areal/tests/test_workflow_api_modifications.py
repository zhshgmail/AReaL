...
class TestWorkflowExecutorDefensiveValidation:
    ...
    def test_requires_output_queue(self, mock_executor_class):
    ...
    @patch("areal.api.workflow_api.WorkflowExecutor")
    def test_requires_result_cache(self, mock_executor_class):
    ...
    @patch("areal.api.workflow_api.WorkflowExecutor")
    def test_requires_both_queue_and_cache(self, mock_executor_class):
...
class TestWorkflowExecutorProximalRecomputation:
    ...
    def test_recompute_proximal_logprobs_calls_recomputer(self):
        ...
        # Should have accessed cache (implementation detail, but testing integration)
        mock_cache.size.assert_called()
